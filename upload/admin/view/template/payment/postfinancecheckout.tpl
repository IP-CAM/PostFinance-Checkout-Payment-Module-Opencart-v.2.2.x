...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			...
			<div class="pull-right">
				<button type="submit" data-toggle="tooltip" form="form-postfinancecheckout"
	...
	<div class="container-fluid">
		...
		<form action="<?php echo $action ?>" method="post"
			enctype="multipart/form-data" id="form-postfinancecheckout"
				...
				<div class="panel-body">
					<fieldset>
						...
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="postfinancecheckout_user_id"><span
								data-toggle="tooltip"
								title="<?php echo htmlspecialchars($help_user_id) ?>"><?php echo htmlspecialchars($entry_user_id) ?></span></label>

							<div class="col-sm-10">
								<input type="text" name="postfinancecheckout_user_id"
									value="<?php echo htmlspecialchars($postfinancecheckout_user_id) ?>"
									id="postfinancecheckout_user_id" class="form-control" />
							</div>
						</div>

						<div class="form-group required">
							<label class="col-sm-2 control-label"
								for="postfinancecheckout_application_key"><span data-toggle="tooltip"
								title="<?php echo htmlspecialchars($help_application_key) ?>"><?php echo htmlspecialchars($entry_application_key) ?></span></label>

							<div class="col-sm-10">
								<input type="password" name="postfinancecheckout_application_key"
									value="<?php echo htmlspecialchars($postfinancecheckout_application_key) ?>"
									id="postfinancecheckout_application_key" class="form-control" />
							</div>
						</div>
					</fieldset>
				</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<fieldset>
								...
								<div class="form-group required">
									<label class="col-sm-2 control-label" for="stores[<?php echo $store['id']; ?>][postfinancecheckout_status]"><?php echo $entry_status; ?></label>

									<div class="col-sm-10">
										<select	name="stores[<?php echo $store['id']; ?>][postfinancecheckout_status]"
											id="stores[<?php echo $store['id']; ?>][postfinancecheckout_status]" class="form-control">
											<option value="0"<?php if (!$stores[$store['id']]['postfinancecheckout_status']) { echo 'selected="selected"'; }?>><?php echo $text_disabled;?></option>
											<option value="1"<?php if ($stores[$store['id']]['postfinancecheckout_status']) { echo 'selected="selected"'; }?>><?php echo $text_enabled;?></option>
										</select>
									</div>
								</div>

								<div class="form-group required">
									<label class="col-sm-2 control-label" for="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_id]"><span
										data-toggle="tooltip"
										title="<?php echo htmlspecialchars($help_space_id) ?>"><?php echo htmlspecialchars($entry_space_id) ?></span></label>

									<div class="col-sm-10">
										<input type="text"
											name="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_id]"
											value="<?php echo htmlspecialchars($stores[$store['id']]['postfinancecheckout_space_id']) ?>"
											id="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_id]" class="form-control" />
									</div>
								</div>
							</fieldset>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="checkbox"
											name="stores[<?php echo $store['id'] ?>][postfinancecheckout_download_invoice]"
											<?php if($stores[$store['id']]['postfinancecheckout_download_invoice']) { ?>
											checked <?php } ?> value="1"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="checkbox"
											name="stores[<?php echo $store['id'] ?>][postfinancecheckout_download_packaging]"
											<?php if($stores[$store['id']]['postfinancecheckout_download_packaging']) { ?>
											checked <?php } ?> value="1"/>
							...
							<fieldset>
								...
								<?php foreach ($postfinancecheckout_statuses as $status): ?>
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label"
										for="stores[<?php echo $store['id']; ?>][postfinancecheckout_log_level]"><span data-toggle="tooltip"
										title="<?php echo htmlspecialchars($help_log_level) ?>"><?php echo htmlspecialchars($entry_log_level) ?></span></label>

									<div class="col-sm-10">
										<select class="form-control" name="stores[<?php echo $store['id']; ?>][postfinancecheckout_log_level]" id="stores[<?php echo $store['id']; ?>][postfinancecheckout_log_level]">
										<?php foreach($log_levels as $level => $name) :?>
											<option value="<?php echo $level;?>" 
											<?php if ($level == $stores[$store['id']]['postfinancecheckout_log_level']): ?>
											 selected="select"
											<?php endif; ?>
							...
							<fieldset>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label"
										for="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_view_id]"><span data-toggle="tooltip"
										title="<?php echo htmlspecialchars($help_space_view_id) ?>"><?php echo htmlspecialchars($entry_space_view_id) ?></span></label>

									<div class="col-sm-10">
										<input type="text"
											name="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_view_id]"
											value="<?php echo htmlspecialchars($stores[$store['id']]['postfinancecheckout_space_view_id']) ?>"
											id="stores[<?php echo $store['id']; ?>][postfinancecheckout_space_view_id]" class="form-control" />
									</div>
								</div>
							</fieldset>
							<fieldset>
				...
				<div class="panel-body">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static">2022/10/07 11:00:28</p>
							</div>
						</div>
					</fieldset>
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static"><?php echo $postfinancecheckout_migration_name ?></p>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<p class="form-control-static"><?php echo $postfinancecheckout_migration_version ?></p>
							</div>
						</div>
					</fieldset>
				</div>
