...
class ModelExtensionPostFinanceCheckoutSetup extends AbstractModel {
	...
	private function addEvents(){
		$this->getEventModel()->addEvent('postfinancecheckout_create_dynamic_files', 'admin/controller/extension/modification/after',
	...
	private function removeEvents(){
		...
		$this->getEventModel()->deleteEvent('postfinancecheckout_include_scripts');
	}
